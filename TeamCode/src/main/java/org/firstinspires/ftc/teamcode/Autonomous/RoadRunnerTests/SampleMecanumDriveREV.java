 ...
 */
public class SampleMecanumDriveREV extends org.firstinspires.ftc.teamcode.drive.SampleMecanumDriveBase {
    ...
    public List<Double> getWheelPositions() {
        ...
        for (DcMotorEx motor : motors) {
            wheelPositions.add(org.firstinspires.ftc.teamcode.drive.DriveConstants.encoderTicksToInches(motor.getCurrentPosition()));
        }
