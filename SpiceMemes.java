...
@Disabled
@TeleOp(name = "Spice Memes", group = "Working")
public class SpiceMemes extends LinearOpMode {
  ...
  static final double ACTUATOR_COUNTS_PER_INCH = (COUNTS_PER_MOTOR_REV * DRIVE_GEAR_REDUCTION) / (ACTUATOR_GEAR_DIAMETER 
                                                                                                  * PI);
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) 
      {
       ...
       {
         latch.setPosition(0.60);
       }
       
       else if(gamepad2.right_bumper)
       {
         latch.setPosition(0.40);
       }
       
       else if(gamepad2.dpad_up)
       {
         latch.setPosition(0.20);
       }
       ...
       /*if(pulley.getCurrentPosition() >= 6500)
       {
         pulley.setMode(DcMotor.RunMode.RUN_TO_POSITION);
         pulley.setTargetPosition(6450);
         pulley.setPower(1);
